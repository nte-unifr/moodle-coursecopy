...
define('PAGE_TITLE', 'Moodle @ UNIFR');
...
$year_text 		= 	optional_param('YEAR_TEXT', '', PARAM_CLEANHTML);	// Of type : Text
...
$PAGE->navbar->add('Archive courses');

$archive_obj = new Archive($step, $year_text, $spr_s, $aut_s, $two_s, $hidden, $archived);
